...
# GUI module for: Project Orchard (Apple) (orchard)
# Responsibilities:
...
bootstrap_web_gui() {
  ...
  echo "[GUI:orchard] Web GUI bootstrap not yet implemented."
}

bootstrap_macos_app() {
  # TODO: Integrate with a macOS app (Swift/Objective-C) via APIs or local IPC.
  echo "[GUI:orchard] macOS GUI bootstrap not yet implemented."
}
